...
1. Are there systemic differences in representativeness, missing data, input data distributions, or output data distributions between the data used to train the model, the data used to test the model, and the data for the population or setting into which the AI system will be deployed?
